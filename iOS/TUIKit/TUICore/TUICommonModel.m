...
+ (void)createGroupAvatar:(NSArray *)group finished:(void (^)(UIImage *groupAvatar))finished {
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        CGFloat width = groupAvatarWidth / 3 * 0.9;
        ...
        NSLog(@"injected 222 space1=%f space2=%f space3=%f x=%f y=%f", space1,space2,space3, x, y);
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            view.layer.cornerRadius = 4 * wScale;
